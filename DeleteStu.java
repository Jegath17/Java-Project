...
public class DeleteStu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(240, 30, 312, 90);

        jLabel2.setFont(new java.awt.Font("Times New Roman", 3, 24)); // NOI18N
        jLabel2.setText("Student ID");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(189, 164, 128, 41);
        ...
        jButton1.setBounds(320, 323, 98, 32);
        getContentPane().add(sid);
        sid.setBounds(460, 167, 180, 41);
        ...
        jButton2.setBounds(518, 323, 100, 28);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            if (P==0)
            {
                ...
                String sql= "delete from student where stuid = '" + sid.getText() + "'";
